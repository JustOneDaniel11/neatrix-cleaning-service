  ...
  return (
    <section id="testimonials" className="py-12 md:py-20 bg-background">
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-6 md:mb-8">
            <div className="text-center">
              <div className="flex items-center justify-center mb-2">
                <span className="text-2xl md:text-3xl font-bold text-foreground mr-2">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className={`flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg border transition-colors text-sm md:text-base touch-manipulation ${
                  showGoogleReviews 
              ...
              >
                ...
                <span className="hidden sm:inline">Include </span>Google Reviews
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-6 md:mb-8">
          {serviceFilters.map((filter) => (
            <button
              ...
              className={`flex items-center gap-1 md:gap-2 px-3 md:px-4 py-2 rounded-lg border transition-colors text-sm md:text-base touch-manipulation ${
            ...
            >
              ...
              <span className="bg-muted text-muted-foreground px-1.5 md:px-2 py-0.5 md:py-1 rounded-full text-xs">
                {filter.count}
              </span>
            </button>
          ))}
              ...
              <CardContent className="p-4 md:p-6">
                <div className="flex items-start justify-between mb-3 md:mb-4">
                  <div className="flex items-center flex-1 min-w-0">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-primary text-primary-foreground rounded-full flex items-center justify-center font-semibold mr-3 md:mr-4 flex-shrink-0">
                      {review.avatar}
                    </div>
                    <div className="min-w-0 flex-1">
                      ...
                      {'role' in review && (
                        <>
                          ...
                          <p className="text-xs md:text-sm text-muted-foreground truncate">{review.company}</p>
                        </>
                      )}
                    </div>
                  </div>
                ...
                <div className="relative mb-3 md:mb-4">
                  <Quote className="absolute -top-1 md:-top-2 -left-1 md:-left-2 w-6 h-6 md:w-8 md:h-8 text-primary/20" />
                  <p className="text-muted-foreground italic pl-4 md:pl-6 text-sm md:text-base leading-relaxed">
                    "{review.text}"
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between text-xs text-muted-foreground">
                  ...
                  {'helpful' in review && (
                    <div className="flex items-center gap-1 flex-shrink-0 ml-2">
                      ...
                      <span className="hidden sm:inline">{review.helpful} helpful</span>
        ...
        {/* Google Reviews CTA */}
        <div className="text-center mt-8 md:mt-12 p-4 md:p-6 bg-muted rounded-lg">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 md:gap-4">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-blue-600 text-white px-4 md:px-6 py-2.5 md:py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-sm md:text-base touch-manipulation"
            >
              <ExternalLink className="w-4 h-4" />
              Leave Google Review
            </a>
            <button 
              ...
              className="flex items-center justify-center gap-2 bg-primary text-primary-foreground px-4 md:px-6 py-2.5 md:py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors text-sm md:text-base touch-manipulation"
            >
        ...
        <div className="text-center mt-8 md:mt-12">
          ...
          <button 
            ...
            className="bg-primary text-primary-foreground px-6 md:px-8 py-2.5 md:py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors text-sm md:text-base touch-manipulation"
          >
            Get Your Free Quote
          </button>
        </div>
