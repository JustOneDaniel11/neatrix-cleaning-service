  ...
  return (
    <div className={`flex flex-col items-center justify-center space-y-4 ${className}`}>
      ...
      <div className="relative">
        <div className={`${sizeClasses[size]} rounded-full bg-gradient-to-r from-gray-400 to-gray-500 animate-pulse`}>
        ...
        <div className={`absolute inset-0 ${sizeClasses[size]} rounded-full border-2 border-transparent border-t-gray-500 border-r-gray-400 animate-spin`}></div>
      </div>
